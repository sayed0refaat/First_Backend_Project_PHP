...
if(isset($_POST['desc'])){
  ...
  // $userid=$_SESSION['user']['id'];
   ...
   //$res=AddPortfolio($filename,$desc,$userid);
   $res=UpdatePortfolio($pro_id,$desc,$filename);
   if($res){
              ...
              <form action="updateportfolio.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <textarea class="form-control textarea " name="desc" > <?php  echo $data['description']; ?> </textarea>
                  </div>
                  <img src="upload/<?php  echo $data['image']; ?>" width="70px"   >
